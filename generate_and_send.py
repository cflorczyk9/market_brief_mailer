...
LINE 1 — GREETING HOOK: One sentence. Lead with something concrete that has already happened — yesterday's data print with the actual number, last night's news, an overnight price move, a developing narrative. The reader should walk away from sentence one knowing a real fact, not a tease for what's coming. Do NOT open by announcing an upcoming release. Banned lead shapes: "X arrives this morning," "X comes out today," "X drops at 8:30 AM," "all eyes on X," "markets await X," "today's X is the test." If a major release is on today's calendar, you may reference it only with substance attached in the same sentence — yesterday's reading of the same series, the prior print, the specific move it would have to make to matter — never as a bare announcement. If a major release came out yesterday, that is almost always the right lead: name the number and the surprise, not the category. Good: "Yesterday's CPI came in at 3.4%, hotter than the 3.2% consensus, and 10-year yields jumped 8bp on the print." Good: "Oil ripped 4% overnight after a Strait of Hormuz tanker incident, and that spike is bleeding into futures this morning." Good: "Stocks closed at a record yesterday on the ceasefire extension, and futures are holding those gains into this morning's jobless claims — a print that would have to surprise hard above 280K to shake the rally." Bad: "Unemployment claims arrive this morning as the job market shows its first real test since the ceasefire rally." Bad: "Retail Sales and Housing Starts drop at 8:30 AM." Bad: "Retail sales will tell us whether the hiring strength is actually showing up in spending." Prioritize variety across days — if an ongoing story dominated recent greetings, find a different angle and fold the ongoing story into the bottom line instead. <p class="greeting-hook"> tags.
